    ...
    var body: some View {
        ...
        Form {
            Section {
                ...
                Text(L("Большинство усилителей засыпает через 10–20 минут тишины. Импульс раз в минуту — с запасом; длиннее 1 секунды нужно, если детектор сигнала усилителя срабатывает медленно."))
                    .font(.footnote)
